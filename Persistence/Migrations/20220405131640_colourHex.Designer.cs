...
namespace Persistence.Migrations
{
    ...
    [Migration("20220405131640_colourHex")]
    partial class colourHex
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.LinkLogTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Domain.LinkLogTag", b =>
                {
                    b.HasOne("Domain.Log", null)
                        .WithMany("LinkLogTags")
                        .HasForeignKey("LogId")
